...
from simple_nn_v2.utils import _make_full_featurelist
from simple_nn_v2.features.preprocessing import _split_data, _calc_scale
...
try:
    ...
    scale = _calc_scale(inputs, feature_list_train, logfile, calc_scale=True)
    print('_calc_scale OK')
    print('SCALE : ',scale)
    print('')
except:
    print('!!  Error occured _calc_scale ')
    print(sys.exc_info())
    print('')
