...
from simple_nn_v2.utils.datagenerator import Datagenerator
...
try:
    ...
    data_gen = Datagenerator(descriptor.inputs , descriptor.structure_list , descriptor.pickle_list, parent = model)
...
try:
    ...
    test_struct = [['./generate/OUTCAR_1', '::3'], ['./generate/OUTCAR_11', '::'], ['./generate/OUTCAR_111', '::']]
...
try:
    ...
    tmp_filename = data_gen.save_to_pickle(data,tag_idx,save_dir = './data')
...
try:  ### Something strange for exising data..
    ...
    print('Test save_dir  =./tmp_dir')
    print('Before _data_idx               : ',data_gen._data_idx)
    data_gen.save_to_pickle(data,tag_idx,save_dir = './tmp_dir')
    print('Afert _data_idx (nonexist path)   :',data_gen._data_idx)
    os.system('touch ./tmp_dir/data1.pickle ./tmp_dir/data2.pickle ./tmp_dir/data3.pickle ./tmp_dir/data4.pickle')
    os.system('touch ./tmp_dir/data5.pickle ./tmp_dir/data6.pickle ./tmp_dir/data7.pickle ./tmp_dir/data8.pickle')
    print('Files in ./tmp_dir')
    os.system('ls ./tmp_dir')
    data_gen.save_to_pickle(data,tag_idx,save_dir = './tmp_dir')
...
try:
    print('_'*60)
    print('Symmetry_function.generate() test')
    descriptor.generate(debug = True)
