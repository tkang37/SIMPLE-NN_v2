...
class Symmetry_function(object):    
    ...
    def generate(self , debug = False):
        ...
        if debug: print('_parsing_symf_params() called\n')
        for item, tag_idx in zip(structures, structure_tag_idx):
            ...
            print('load_snapshots() called\n')
            print('Start of for_loop in shapshots\n')
            for snapshot in snapshots:
                ...
                if debug: print('_get_struct_info() called\n')
                ...
                if debug: print('C data input called') 
                ...
                if debug: print('self._init_result() called\n')
                if debug: print('Start of for_loop in self.parent.inputs["atom_types"] of ',snapshot,'\n')
                for _ ,jtem in enumerate(self.parent.inputs['atom_types']):    
                    ...
                    if debug: print('_init_sf_variable() called')
                    ...
                    errno = lib.calculate_sf(cell_p, cart_p, scale_p, \
                                     ...
                                     x_p, dx_p, da_p)
                    if debug: print('calculate_sf() called') 
                    #comm.barrier()
                    ...
                    if debug: print('_set_result() called')
                # End of for loop
                
                # extract E, F, S from snapshot
                result =  self._set_EFS(result, snapshot)
                if debug: print('_set_EFS() called')
                ...
                if debug: print('Datagenerator.save_to_pickle() called')
