...
# Load structure
structure = cal_symmetry_function.open_outcar('OUTCAR_comp')
...
try:
    ...
    pickle_g2 = cal_symmetry_function.load_pickle('data_comp.pickle')   #From picked data
...
try:
    ...
    cal_list = np.array(cal_list)
    print('Calculated SF :', cal_list)
    pickle_g4 = cal_symmetry_function.load_pickle('data_comp.pickle')
...
load = cal_symmetry_function.Test_symmetry_function(output_name = 'OUTCAR_comp' , yaml_name = 'input.yaml' , data_name = 'data_comp.pt')
